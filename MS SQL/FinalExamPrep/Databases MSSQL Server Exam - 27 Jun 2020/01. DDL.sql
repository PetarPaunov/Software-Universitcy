...
(
	...
	StockQty INT DEFAULT 1 CHECK(StockQty > 0)NOT NULL
)
...
(
	...
	CONSTRAINT CompPrimKey_OrderId_PartId  PRIMARY KEY (OrderId, PartId)
)
...
(
	...
	PartId INT REFERENCES Parts(PartId) NOT NULL,
	Quantity INT DEFAULT 1 CHECK (Quantity > 0)
	CONSTRAINT CompPrimKey_JobId_PartId  PRIMARY KEY (JobId, PartId)
)