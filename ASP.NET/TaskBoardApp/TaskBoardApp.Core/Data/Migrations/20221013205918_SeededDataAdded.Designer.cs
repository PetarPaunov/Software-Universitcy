...
namespace TaskBoardApp.Core.Data.Migrations
{
    ...
    [Migration("20221013205918_SeededDataAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskBoardApp.Core.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaskBoardApp.Core.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskBoardApp.Core.Data.Models.Task", b =>
                {
                    ...
                    b.HasOne("TaskBoardApp.Core.Data.Models.ApplicationUser", "Owner")
                        .WithMany()
